...
public class Deposito extends javax.swing.JFrame {
    ...
    if (verificaDeposito()) {
        JOptionPane.showMessageDialog(this, "numero conta " + ma.cont,
                "teste", JOptionPane.INFORMATION_MESSAGE);
        double deposito = Double.parseDouble(ctxdeposito.getText());
      //  int conta = log.conta;
      //  int conta = 34567890;
        double saldoAtualizado = login.alterarSaldo(ma.cont, deposito);
        
        JOptionPane.showMessageDialog(this, "Depósito realizado com sucesso! Novo saldo: " + saldoAtualizado,
                "Depósito", JOptionPane.INFORMATION_MESSAGE);

    } else {
        JOptionPane.showMessageDialog(this, "O depósito mínimo é 1 euro e máximo 1000 euros.",
                "Erro no campo depósito", JOptionPane.ERROR_MESSAGE);
    }
